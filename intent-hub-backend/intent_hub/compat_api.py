...
@app.get("/agents/<int(signed=True):agent_id>/diff")
@require_auth
@api_errors
...
@app.patch("/agents/<int(signed=True):agent_id>")
@require_auth
@api_errors
...
@app.delete("/agents/<int(signed=True):agent_id>")
@require_auth
@api_errors
...
@app.post("/agents/<int(signed=True):agent_id>/restore-fields")
@require_auth
@api_errors
...
@app.post("/agents/<int(signed=True):agent_id>/recommendations")
@require_auth
@api_errors
...
@app.patch("/agents/<int(signed=True):agent_id>/thresholds")
@require_auth
@api_errors
...
@require_auth
def settings():
    return jsonify(compat_config.settings())
...
@app.get("/diagnostics/overlap/<int(signed=True):agent_id>")
@require_auth
@api_errors
