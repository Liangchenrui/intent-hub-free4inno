  ...
  <el-card shadow="never" class="panel-card content-card">
    <div class="toolbar">
      ...
      <div class="toolbar-actions">
        ...
        <el-dropdown split-button type="primary" :loading="syncing" @click="syncVectorsNow('incremental')" @command="syncVectorsNow">
          同步到向量数据库
